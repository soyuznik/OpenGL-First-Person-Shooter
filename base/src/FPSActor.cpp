	...
	:Actor(game)
{
	...
	paths.push_back("resources/images/MUZZLE/muzzle1.png");
	paths.push_back("resources/images/MUZZLE/muzzle2.png");
	paths.push_back("resources/images/MUZZLE/muzzle3.png");
	paths.push_back("resources/images/MUZZLE/muzzle4.png");
	paths.push_back("resources/images/MUZZLE/muzzle5.png");
	paths.push_back("resources/images/MUZZLE/muzzle6.png");
	paths.push_back("resources/images/MUZZLE/muzzle7.png");



	effect = new Effect(paths);
	...
	mMeshComp->SetMesh(game->GetRenderer()->GetMesh("resources/meshes/Rifle.gpmesh"));
